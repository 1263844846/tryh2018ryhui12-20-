...
//        [SDWebImageManager downloadWithURL:photo.url];
        [manager downloadImageWithURL:photo.url options:SDWebImageContinueInBackground | SDWebImageDelayPlaceholder progress:^(NSInteger receivedSize, NSInteger expectedSize) {
