...
//@property (weak, nonatomic) IBOutlet UILabel *touzirenlable;
//@property (weak, nonatomic) IBOutlet UILabel *touzijinerlable;
//
//@end
//
...
//    
////    [[RHNetworkService instance] POST:@"front/payment/account/countUnReadMessage" parameters:nil success:^(NSURLSessionTask *opp, id responseObject) {
...
////        }
////
////    } failure:^(NSURLSessionTask *opp, NSError *rss) {
////        ;
////    }];
////
...
//            
//        }else{
//        NSString * str =[[dic objectForKey:@"limitTime"] stringValue];
//       _limitTimeLabel.text= str;
//        }
//    }
//   
...
//        self.projectFundLabel.text = [NSString stringWithFormat:@"%.2f",mo/10000.0];
//    }else{
...
////    
////    [[RHNetworkService instance] POST:@"common/main/projectInvestmentList" parameters:parameters success:^(NSURLSessionTask *opp, id responseObject) {
...
////    [[RHNetworkService instance] POST:@"common/main/appXueDetailData" parameters:parameters success:^(NSURLSessionTask *opp, id responseObject) {
////        if ([responseObject isKindOfClass:[NSDictionary class]]) {
...
//    NSDictionary* parameters=@{@"id":projectId};
//    
//    [[RHNetworkService instance] POST:@"common/main/appShangDetailData" parameters:parameters success:^(NSURLSessionTask *opp, id responseObject) {
//        if ([responseObject isKindOfClass:[NSDictionary class]]) {
...
//    
//    cell = (RHProjectDetailViewCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
//    if (cell == nil) {
