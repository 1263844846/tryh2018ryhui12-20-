...
@interface RHJXHKSQViewController ()<UIWebViewDelegate>
{
...
@implementation RHJXHKSQViewController
...
- (void)viewDidLoad {
        ...
        NSString *body = [NSString stringWithFormat: @"authType=withdraw&type=repay"];
    ...
    if (session1.length>12) {
        ...
        //    }
        [self configTitleWithString:@"还款授权"];
    ...
    -(BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
    {
        ...
        if ([url rangeOfString:@"common/paymentJxResponse/repayAuthPageBeforeRet"].location !=NSNotFound) {
