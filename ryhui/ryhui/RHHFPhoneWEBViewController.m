//
//  RHHFPhoneWEBViewController.m
//  ryhui
//
//  Created by 糊涂虫 on 16/8/16.
//  Copyright © 2016年 stefan. All rights reserved.
//

#import "RHHFPhoneWEBViewController.h"

@interface RHHFPhoneWEBViewController ()<UIWebViewDelegate>
...
@implementation RHHFPhoneWEBViewController
...
-(void)viewWillAppear:(BOOL)animated {
   ...
   NSString * strurl = [NSString stringWithFormat:@"%@app/common/user/appUser/updatePhoneNumberHF",[RHNetworkService instance].newdoMain];
