...
{
    if ([type isEqualToString:@"Recharge"]||[type isEqualToString:@"Interest"]||[type isEqualToString:@"Capital"]||[type isEqualToString:@"PenaltyInterest"]||[type isEqualToString:@"PrepaymentPenalty"] || [type isEqualToString:@"SubsidyInterest"]) {
        return 0;
    }
